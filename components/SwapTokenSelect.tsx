...
class ItemRenderer extends PureComponent<ItemRendererProps> {
  render() {
    ...
    return (
      <div style={this.props.style} className="swapt1">
        <button
          key={tokenInfo?.address}
          className=" swapt flex font-normal justify-between items-center py-4 hover:bg-th-bkg-4 cursor-pointer px-6 rounded-none w-full focus:outline-none focus:bg-th-bkg-3"
...
const SwapTokenSelect = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} hideClose alignTop>
      <div>
